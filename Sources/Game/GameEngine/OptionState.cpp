...
namespace gameEngine
{
		...
		: State(gameEngine, replace)
	{
		...
		std::unique_ptr<gui::Label> l1 = std::make_unique<gui::Label>("Option menu", *AssetManager::Instance()->GetFont("Resources/Fonts/EnchantedLand-jnX9.ttf"), 96, sf::Text::Bold, sf::Color::White, sf::Vector2f(0, -400));
		...
		b1->setMouseButtonReleasedCallback([&]() { this->toReturn(); });
